...
class _PointsPopupState extends State<PointsPopup> {
  ...
  Future<void> _claimBonus() async {
    ...
    try {
      final response = await PointsApi.redeemGiftPoints(widget.giftId);
      if (response.success) {
        setState(() {
          _showSuccess = true;
        });
  ...
  Widget _buildGiftChild(BuildContext context) => Container(
    ...
    child: Column(
      ...
      children: [
        Image.asset(
          'assets/images/icons/metaCumplida.png',
          height: 120,
          fit: BoxFit.contain,
  ...
  Widget _buildSuccessChild(BuildContext context) => Container(
    ...
    child: Column(
      ...
      children: [
        Image.asset(
          'assets/images/icons/regaloMeta.png',
          height: 120,
          fit: BoxFit.contain,
          errorBuilder: (context, error, stackTrace) {
        ...
        const SizedBox(height: 10),
        Text(
          'Te hemos obsequiado ${widget.points} puntos por tu compromiso y dedicacion.',
